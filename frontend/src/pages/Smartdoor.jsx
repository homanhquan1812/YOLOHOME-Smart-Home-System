...
import SmartdoorHeads from '../components/SmartdoorHeads';
import SmartdoorScripts from '../components/SmartdoorScripts'
...
const Smartdoor = () => {
  ...
  const handleNumberClick = (number) => {
    if (code.length < 4) {
      ...
      setCode(newCode);
      handlePassword(newCode);
      console.log("Number entered:", number); // Log the entered number
    }
  };

  const handleClear = () => {
    console.log("Code cleared:", code); // Log the code before clearing
    setCode('');
  };
...
const handlePassword = async (enteredNumber) => {
  try {
    ...
    const response = await fetch('https://yolohome-smart-home-system-api.onrender.com/smartdoor', {
      ...
      body: JSON.stringify({ action: 'enterKey', enteredNumber}) // Pass enteredNumber to the server
                      ...
                      <ul className="timeline">
                        <li>
                          ...
                          <a className="timeline-panel text-muted" href="javascript:void(0);">
                            ...
                            <h6 className="mb-0">Youtube, a video-sharing website, goes live
                        ...
                        <li>
                          ...
                          <a className="timeline-panel text-muted" href="javascript:void(0);">
                            <span>20 minutes ago</span>
                            <h6 className="mb-0">Mashable, a news website and blog, goes live.
                            </h6>
                          </a>
                        </li>
                        <li>
      ...
      <div className="deznav-scroll">
        <ul className="metismenu" id="menu">
          ...
          <li><a href="javascript:void(0);" aria-expanded="false">
            ...
            </a><a className="nav-text" href="dashboard">Dashboard</a>
          ...
          <li><a className="has-arrow " href="javascript:void(0);" aria-expanded="false">
            ...
            </a><a className="nav-text" href="./Smartdoor.html">Smartdoor</a>
            {/* <ul aria-expanded="false">
  ...
  ************************************/}
    <div className="content-body">
      <div className="container-fluid">
        <div className="row">
          {/*
          <div className="col-xl-6  col-lg-12 noti_fication">
            <div className="card noti_body">
              <span className="material-symbols-outlined bell-icon"> <i className="fas fa-bell" /> </span>
              <span className="material-symbols-outlined bell-icon"> <i className="fas fa-bell" /> </span>
              <span className="material-symbols-outlined bell-icon"> <i className="fas fa-bell" /> </span>
              <span className="material-symbols-outlined bell-icon"> <i className="fas fa-bell" /> </span>
              <span className="material-symbols-outlined bell-icon"> <i className="fas fa-bell" /> </span>
              ...
              <div id="bell" onclick="toggleNotifications()">
                <div id="heading" className="opacity_0">Notifications</div>
                <div className="bellIcon">
                  <span className="material-symbols-outlined bellDefault">
                    <i className="fas fa-bell" />
                  </span>
                  <span className="material-symbols-outlined bellHover">
                    <i className="fas fa-bell" />
                  </span>
                  <div id="count">3</div>
                </div>
              </div>
              <div id="allNotifications" className="d-none" />
            </div>
          </div>
          */}
          <div className="col-xl-6  col-lg-12 pincode">
            <div className="card pincode-body ">
              <center>
                <h2>Enter The Code</h2>
                <div id="containor">
                  <div id="y" className="x numberS animated bounceIn" onclick="check()">Check</div>
                  <input type="textfield" class="field animated bounceInUp" id="field" maxlength="4" />
                  <div id="x" className="x numberS animated bounceIn" onClick={handleClear}>x</div>
                  <div id="cont">
                    {[1, 2, 3, 4, 5, 6, 7, 8, 9, '#', '0', '*'].map((num, index) => ([
                      num !== '*' ? (
                        <div
                          className="number animated bounceIn"
                      ...
                      (index + 1) % 3 === 0 && index !== 11 && <br key={`br-${index}`} />
                    ]))}
                  </div>
                </div>
              </center>
